      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-foreground sm:text-5xl md:text-6xl">
            Chat with AI
            <span className="text-primary"> Powered by AWS Bedrock</span>
          </h1>
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="bg-card rounded-lg shadow-md p-6 border border-border">
              ...
              <h3 className="mt-4 text-lg font-medium text-card-foreground">Smart Conversations</h3>
            ...
            <div className="bg-card rounded-lg shadow-md p-6 border border-border">
              ...
              <h3 className="mt-4 text-lg font-medium text-card-foreground">Bot Marketplace</h3>
              <p className="mt-2 text-base text-muted-foreground">
            ...
            <div className="bg-card rounded-lg shadow-md p-6 border border-border">
              ...
              <h3 className="mt-4 text-lg font-medium text-card-foreground">Knowledge Integration</h3>
              <p className="mt-2 text-base text-muted-foreground">
            ...
            <div className="bg-card rounded-lg shadow-md p-6 border border-border">
              ...
              <h3 className="mt-4 text-lg font-medium text-card-foreground">Custom Bots</h3>
              <p className="mt-2 text-base text-muted-foreground">
